		...
		case OPCODE_R:
			...
			switch (CPUDATA.INST.R.FUNC)
			{
				...
				case FUNC_DIV:
				  ...
				  CPUDATA.REGHI = CPUDATA.BANK[CPUDATA.INST.R.REGA] % CPUDATA.BANK[CPUDATA.INST.R.REGB];
				  CPUDATA.REGLO = CPUDATA.BANK[CPUDATA.INST.R.REGA] / CPUDATA.BANK[CPUDATA.INST.R.REGB];
